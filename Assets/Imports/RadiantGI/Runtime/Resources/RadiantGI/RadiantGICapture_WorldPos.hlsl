...
#define RGI_CAPTURE_WORLDPOS
	...
	// Copyright Kronnect - All Rights Reserved.
	...
	VaryingsWorldPos VertRGI(AttributesFS input) {
        ...
        output.pos.y *= _ProjectionParams.x;
        output.uv = input.uv;
    ...
    float GetDepth(float2 uv) {
        float depth01 = UNITY_SAMPLE_DEPTH(UNITY_SAMPLE_SCREENSPACE_TEXTURE(_CameraDepthTexture, uv));
        #if UNITY_REVERSED_Z
            depth01 = 1.0 - depth01;
        #endif
        return depth01;
