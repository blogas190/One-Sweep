...
namespace RadiantGI.Universal {
    ...
    public class RadiantShadowMapRenderFeature : ScriptableRendererFeature {
        ...
        class RadiantRSMPass : ScriptableRenderPass {
            ...
            static void ExecutePass(PassData pd) {
                ...
                captureMat.SetMatrix(RadiantShadowMap.ShaderParams.ClipToWorld, clipToWorld);
                captureMat.SetVector(RadiantShadowMap.ShaderParams.ClipDir, RadiantShadowMap.clipDirRef);
                captureMat.SetFloat(RadiantShadowMap.ShaderParams.FarClipPlane, cam.farClipPlane);
